const hero = require('@windicss/plugin-heropatterns')
const { defineConfig } = require('windicss/helpers')
const plugin = require('windicss/plugin')
const ratio = require('windicss/plugin/aspect-ratio')
		...
		plugin(function({ addVariant, addDynamic, theme }) {
			...
			for (const [k, v] of Object.entries(autoRatio)) {
				...
				addDynamic(`${k}-o`, ({ Utility, Style }) => {
					...
					for (const [idx, size] of Object.values(theme('container.screens', theme('screens'))).entries()) {
